...
<html lang="en">
<?php 
$pageTitle = 'Registry: Modify Customer';
                        ...
                        <form method="POST" action="" class="intelligence-form">
                            ...
                            <div class="form-footer">
                                <div class="disclaimer-note">
                                    ...
                                    Modifying this profile will affect all future invoices and communication historical logs.
                                </div>
                                <div class="action-buttons">
                                    <a href="delete_customer.php?id=<?= $c['id'] ?>" class="btn btn-outline btn-red" onclick="return confirm('Archive permanently?')">Archive</a>
