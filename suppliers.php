        ...
        <div class="main-content">
            ...
            <header class="page-header animate-fade-in">
                <div class="header-titles">
                    <h1 class="header-main">Suppliers Directory</h1>
                    <p class="text-muted">Manage your vendor relationships and procurement contacts.</p>
                </div>
            ...
            <div class="inventory-controls animate-fade-in" style="animation-delay: 0.1s">
                <div class="search-box glass">
                    <form method="GET" action="" class="search-form">
                        ...
                        <input type="text" name="search" class="search-input" placeholder="Search suppliers..." value="<?= htmlspecialchars($search) ?>">
                    </form>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-cell">
                                                <span class="p-name"><?= htmlspecialchars($s['name']) ?></span>
                                                <span class="p-desc">Added <?= date('M d, Y', strtotime($s['created_at'])) ?></span>
                                            </div>
                                        </td>
                                        <td class="font-bold"><?= htmlspecialchars($s['contact_person'] ?: 'N/A') ?></td>
                                        <td>
                                            <div class="contact-info">
                                                <span><?= htmlspecialchars($s['phone'] ?: '-') ?></span>
                                                <span class="email-tag"><?= htmlspecialchars($s['email'] ?: '-') ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="product-cell">
                                                <span class="p-desc truncate"><?= htmlspecialchars($s['address'] ?: 'No address') ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="action-cell">
                                                <a href="edit_supplier.php?id=<?= $s['id'] ?>" class="act-btn edit">
                                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                    </svg>
                                                </a>
                                                <a href="delete_supplier.php?id=<?= $s['id'] ?>" class="act-btn del" onclick="return confirm('Remove supplier?')">
                                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
