...
<html lang="en">
<?php 
$pageTitle = 'Registry: New Supplier';
                        ...
                        <form method="POST" action="" class="intelligence-form">
                            ...
                            <div class="form-footer">
                                <div class="disclaimer-note">
                                    ...
                                    Adding this vendor to the procurement logic will allow you to associate purchases and track stock aging across specific origins.
                                </div>
                                <div class="action-buttons">
                                    <a href="suppliers.php" class="btn btn-outline">Discard</a>
                                    <button type="submit" class="btn btn-primary">Initialize Supplier</button>
                                </div>
                            </div>
                        </form>
                    </div>
